...
def em_algorithm(y, Z, X, max_iter=200, tol=1e-6, omega=np.zeros(10), sigma_b2=1, sigma_e2=1):
    """
...
def plot_marginal_likelihood(log_marginal_likelihoods, save_path):
    plt.figure(figsize=(5, 3), dpi=300)
    plt.plot(log_marginal_likelihoods)
